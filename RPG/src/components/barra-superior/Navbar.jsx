...
// --- NOVOS IMPORTS ---
import MenuLateral from "../barra-lateral/MenuLateral"; 
...
export default function Navbar() {
    ...
    // --- NOVO ESTADO PARA O MENU DE GRUPOS ---
        ...
        if (usuarioLogado?.id) {
            try {
                ...
                if (res.user) {
                    ...
                    authService.updateUserData(res.user); // Atualiza localStorage
                }
            } catch (error) {
    ...
    return (
        ...
        {/* --- LÓGICA DO BOTÃO DE HAMBÚRGUER ATUALIZADA --- */}
        ...
        {/* Menu de Admin (Existente) */}
        {settingsMenuAberto && (
            <SettingsMenu onClose={() => setSettingsMenuAberto(false)} />
        )}

        {/* --- NOVO MENU LATERAL (Para Usuários Comuns) --- */}
        <MenuLateral 
