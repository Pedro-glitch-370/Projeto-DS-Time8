...
### Backend (projeto-ds-time8-backend-service:latest):
- Ambiente Node.js versão 20
- Dependências da aplicação instaladas via npm
- Código-fonte da API
- Configuração de porta 5001
- Script de inicialização utilizando npm start
- Variável de ambiente para conexão com o banco de dados MongoDB

### Frontend (projeto-ds-time8-frontend-service:latest):
- Ambiente Node.js versão 20
- Dependências do frontend instaladas via npm
- Código-fonte da aplicação React
- Servidor de desenvolvimento Vite
- Porta 5173 exposta para acesso externo
