...
try {
    ...
    console.log("⚠️ Aviso: cronService não encontrado ou com erro. A distribuição mensal não rodará.");
}
...
const startServer = async () => {
  try {
    ...
    const server = app.listen(PORT, () => {
      ...
      console.log(`URL: http://localhost:${PORT}/api/pinos`) // rota que pega todos os pinos
